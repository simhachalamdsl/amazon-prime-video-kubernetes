pipeline{
    ...
    stages {
        ...
        stage('Checkout from Git'){
            steps{
                git branch: 'main', url: 'https://github.com/simhachalamdsl/amazon-prime-video-kubernetes.git'
            }
        }
    ...
    always {
        script {
            ...
            emailext (
                ...
                """,
                to: 'tsimhachalam08@gmail.com',
                from: 'tsimhachalam08@gmail.com',
                replyTo: 'tsimhachalam08@gmail.com',
                mimeType: 'text/html',
